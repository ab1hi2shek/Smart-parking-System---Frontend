...
export const SAVE_CAR_DATA = 'SAVE_CAR_DATA';
export const SHORTEST_PARKING_MESSAGE = 'SHORTEST_PARKING_MESSAGE';
export const SAVE_SHORTEST_DATA = 'SAVE_SHORTEST_DATA';
export const SHOW_MAP_TO_PAGE = 'SHOW MAP_TO_PAGE';
export const HIDE_MAP_FROM_PAGE = 'HIDE_MAP_FROM_PAGE';